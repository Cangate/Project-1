...
public class Makepizza extends JPanel{
	
	int x;
	int k=0;
	public int h=4;
	public int pizza=0,ca=0;
	public int sc=0;
	int d,s,c,p,ck ;
        Timer t1;
	...
	JButton pep = new JButton(new ImageIcon("Media/u_peperonis.png"));
        JButton cake = new JButton(new ImageIcon("Media/cake1.png"));
	...
	Makepizza(){
		...
		this.p=Maingame.frame.order.pizza.getp();
                this.ck=Maingame.frame.order.pizza.getck();
					 ...
					 if(d==1&&s==1&&c==1&&p==1) {
						 ...
						 Maingame.frame.remove(Maingame.frame.make);
							...
							System.out.println("h:"+h);
                                  ...
                                  if(Maingame.frame.order.getX()==6) {
					 if(d==1&&s==0&&c==0&&p==1&&ck==1) {
						 Maingame.frame.order.x=0;
						 x=0;
						 sc =1;
						 int m=20;
	 ...
	 protected void paintComponent(Graphics g){
		  ...
		  g.drawString(""+Maingame.frame.score.getSc(), 600,37);
				...
				if (ca ==1){
                                    ImageIcon cai= new ImageIcon("Media/cake1.png");
                                    cai.paintIcon(this, g, 285, 245);
